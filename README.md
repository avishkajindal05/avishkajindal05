## Hi there, I am Avishka Jindal

# 💫 About Me:
A passionate AI/ML Engineer and Researcher from India<br><br>🚀 Final-year B.Tech (AI & ML) student with hands-on experience in AI engineering, computer vision, and information security, including research at DRDO.<br>🧠 Actively working on Quantum Algorithms (QAOA), Reversible Data Hiding, and deep learning models that go beyond academic demos.<br>📦 Strong focus on clean, efficient Python code, reproducible research, and real-world problem solving.<br>🤝 Always open to learning, collaboration, and impactful AI research.<br><br>📧 Email: avishkajindal05@gmail.com<br><br>💬 Ask me about: AI/ML, Computer Vision, Quantum ML, Research Collaboration<br>⚡ Fun fact: I have just started learning classical dance


## 🌐 Socials:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/avishkajindal05) [![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:avishkajindal05@gmail.com) 
